from dns_server import UnprocessedPackage
...
class DNSPackage:
    ...
    def add_RR(self, name, type_number, qclass, TTL, RDLENGTH, RDATA):
        self._data += b''.join(
    ...
    def update_data(self):
        ...
        for name, type_number, qclass, TTL, RDLENGTH, RDATA in self.answers + self.authoritys + self.additionals:
            self.add_RR(name, type_number, qclass, TTL, RDLENGTH, RDATA)
